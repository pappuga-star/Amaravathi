...
type Bench = { warmMs: number; cacheHitRatioPct?: number };
const baseline = JSON.parse(readFileSync(baselinePath, 'utf8')) as Bench;
const current = JSON.parse(readFileSync(currentPath, 'utf8')) as Bench;
