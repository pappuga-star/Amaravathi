...
export const LanguageSwitcher = () => {
  ...
  return (
    ...
    >
      <span className={!isTelugu ? "font-bold text-emerald-700" : "font-medium text-slate-500"}>English</span>
      <span className="text-slate-300 mx-1.5">|</span>
      <span className={isTelugu ? "font-bold text-emerald-700" : "font-medium text-slate-500"}>తెలుగు</span>
    </button>
  );
};
